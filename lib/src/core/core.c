...
static long parameters(struct Arrays *as1, struct Parameters *as2, long which,
                       eb_core_progress_callback_handler_t *callback);
...
static void set_progress(eb_core_progress_callback_handler_t *callback, int current_kernel, int current_run) {
...
void *BENCHMARK_INCLUDE_OPTIMIZATION(void *benchmark_args_as_void) {
  eb_core_args_t *benchmark_args = (eb_core_args_t *)benchmark_args_as_void;
  eb_core_progress_callback_handler_t *callback_handler = &benchmark_args->callback_handler;

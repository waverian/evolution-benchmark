...
fprintf(
    file_handler,
    "</td>\n		</tr>\n		</tbody>\n	</table>\n	<div>\n		<h1 class=\"thin_font\">");
fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].score));
fprintf(file_handler,
        "\n		</h1>\n		<h3 class=\"thin_font\">Overall score</h3>\n	</div>\n	<br>\n	"
        "<div>\n		<table>\n			<tr>\n				<td "
        "class=\"no_border\">\n					<div class=\"sub_result_div white_on_blue\">\n	"
        "					<h2 class=\"thin_font\">");
if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_SINGLE_CORE].valid) {
  fprintf(file_handler, "%.*f",
          AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_SINGLE_CORE].score));
} else {
...
if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_MULTI_CORE].valid) {
  fprintf(file_handler, "%.*f",
          AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_MULTI_CORE].score));
} else {
  fprintf(file_handler, "N/A");
}
...
if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_QUAD_CORE].valid) {
  fprintf(file_handler, "%.*f",
          AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_QUAD_CORE].score));
} else {
  fprintf(file_handler, "N/A");
}
fprintf(file_handler, "</h2>\n						<h4 class=\"thin_font\">");
...
if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_WORKSTATION].valid) {
  fprintf(file_handler, "%.*f",
          AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[EB_RUN_TYPE_WORKSTATION].score));
} else {
  fprintf(file_handler, "N/A");
}
fprintf(file_handler, "</h2>\n						<h4 class=\"thin_font\">");
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%s", EB_RUN_TYPE_NAMES[j]);
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].maximum));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].average));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].geometric));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].harmonic));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].minimum));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (i = 0; i < EB_KERNEL_COUNT; i++) {
  ...
  fprintf(file_handler, ".</td>\n				<td>");
  fprintf(file_handler, "%s", EB_KERNEL_NAMES[i]);
  fprintf(file_handler, "</td>");
  for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
    if (result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].valid) {
      fprintf(file_handler, "\n				<td>");
      fprintf(file_handler, "%.*f",
              AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_DISABLED].detailed[j].kernels[i]));
      fprintf(file_handler, "</td>");
    }
  }
  fprintf(file_handler, "\n			</tr>");
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].maximum));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].average));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].geometric));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].harmonic));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
  if (result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].valid) {
    fprintf(file_handler, "\n				<td>");
    fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].minimum));
    fprintf(file_handler, "</td>");
  }
}
fprintf(file_handler,
...
for (i = 0; i < EB_KERNEL_COUNT; i++) {
  ...
  for (j = 0; j < EB_RUN_TYPE_SIZE; j++) {
    if (result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].valid) {
      fprintf(file_handler, "\n				<td>");
      fprintf(file_handler, "%.*f", AUTO_PRECISION(result.full_result[EB_OPTIMIZATION_ENABLED].detailed[j].kernels[i]));
      fprintf(file_handler, "</td>");
    }
  }
  fprintf(file_handler, "\n			</tr>");

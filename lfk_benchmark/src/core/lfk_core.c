  ...
  if (reliability) {
    ...
    if (count2 == 1) {
      ...
      if (strcmp(chek1, chek2) != 0) {
        ...
        /*fprintf(NULL, " Section %d Test %2d pass %5ld Non-standard result was
      ...
      if (strcmp(chek1, chek2) != 0) {
        ...
        if (failCount < 6) {
            fprintf(NULL, " Section %d Test %2d pass %5ld Different result was
        %s expected %s\n", i + 1, j, count2, chek1, chek2); fflush(NULL);
        }*/
      }
    }
  } else {
    for (i = 0; i < 3; i++) {
      for (j = 1; j < 25; j++) {
        ...
        if (strcmp(chek1, chek2) != 0) {
          errors = errors + 1;
          /*   fprintf(NULL, " Section %d Test %2d Non-standard result was %s
             expected %s\n", i + 1, j, chek1, chek2);*/
        }
      }
    }
    /*        if (errors == 0) {
                ...
                fprintf(NULL, "\n Compiler #define or values in linpack.c might
       to be changed\n");
            }
            fprintf(NULL, "\n");*/
  }
